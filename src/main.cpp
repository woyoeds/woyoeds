...
int64 nChainStartTime = 1523418285; //2018/4/11 11:44:45
...
const string strMessageMagic = "WOYO Education Share Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in edushare
    bool fStrictPayToScriptHash = true; // Always active in edushare
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "edushare", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Senators vented at Facebook CEO Mark Zuckerberg — but may leave it at that 2018/4/11";
        CTransaction txNew;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0x90c101a9cf842628d08140288af2ec2acf81daa285d5d93a63f00e255bfc67ec"));
...
unsigned char pchMessageStart[4] = { 0xca, 0xf6, 0x3a, 0x11 };
